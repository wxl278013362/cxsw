...
message_startup = """
{"code":"key3", "msg":"Printer is not ready
...
class Printer:
    ...
    def _connect(self, eventtime):
        try:
            ...
            self._set_state('{"code":"key0", "msg":"%s%s"}' % (str(e), message_mcu_connect_error))
            util.dump_mcu_build()
            return
    ...
    def invoke_shutdown(self, msg):
        ...
        self._set_state('{"code":"key1", "msg":"%s%s"}' % (msg, message_shutdown))
